      ...
      <div className='info-conteiner'>
        {isMobile ? (
            ...
            <div className='carousel-item'>
              <div className="info-item">
                <div className="icon-circle">
                  <svg className="health-icon" role="presentation" fill="none" focusable="false" strokeWidth="2" width="32" height="32" viewBox="0 0 24 24">
          ...
          <>
            ...
            <div className="info-item">
              <div className="icon-circle">
                <svg className="taste-icon" role="presentation" fill="none" focusable="false" strokeWidth="2" width="32" height="32" viewBox="0 0 24 24">
            ...
            <div className="info-item">
              <div className="icon-circle">
                <svg className="cost-icon" role="presentation" fill="none" focusable="false" strokeWidth="2" width="32" height="32" viewBox="0 0 24 24">
